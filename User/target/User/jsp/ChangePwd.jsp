                ...
                <div class="panel-body" style="height: 100%">
                    <div class="row" style="margin-top: 200px;">
                        <div class="input-group col-lg-6 col-lg-offset-3" style="text-align: center">
                            ...
                            <input type="button" id="txtOldPassword" class="form-control" placeholder="Old password" aria-describedby="basic-addon1" inputmode="password"/>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="input-group col-lg-6 col-lg-offset-3" style="text-align: center">
                            ...
                            <input type="button" id="txtNewPassword" runat="server" class="form-control" placeholder="New password" aria-describedby="basic-addon1" TextMode="Password"></input>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="input-group col-lg-6 col-lg-offset-3" style="text-align: center">
                            <span id="lblNewPasswordAgain" runat="server" Style="width: 150px" class="input-group-addon input-group-lg" >请再次输入密码：</asp:Label>
                            <input type="button" id="txtNewPasswordAgain" class="form-control" placeholder="New password Again" aria-describedby="basic-addon1" inputmode="password"></input>
                        </div>
                    </div>
                    <br />
                    <div class="row">
