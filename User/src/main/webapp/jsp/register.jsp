                ...
                <div class="panel-body" style="height: 100%">
                    ...
                    <div class="row">
                        <div class="input-group col-lg-6 col-lg-offset-3" style="text-align: center">
                            ...
                            <input type="text" id="txtPassword"  class="form-control" placeholder="Password" aria-describedby="basic-addon1"></input>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="input-group col-lg-6 col-lg-offset-3" style="text-align: center">
                            ...
                            <input type="text" id="txtPasswordAgain" class="form-control" placeholder="Password Again" aria-describedby="basic-addon1"></input>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="input-group col-lg-6 col-lg-offset-3" style="text-align: center">
                            ...
                            <input type="text" id="txtEmail"  class="form-control" placeholder="Email" aria-describedby="basic-addon1"></input>
                        </div>
                    </div>
                    <br />
                    <div class="row">
